...
func DeleteProductEndpointHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteProductEndpointReq
		...
		l := productendpoint.NewDeleteProductEndpointLogic(r.Context(), svcCtx)
		resp, err := l.DeleteProductEndpoint(&req)
