...
func GetProductEndpointHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetProductEndpointReq
		...
		l := productendpoint.NewGetProductEndpointLogic(r.Context(), svcCtx)
		resp, err := l.GetProductEndpoint(&req)
