...
func UpdateProductEndpointHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateProductEndpointReq
		...
		l := productendpoint.NewUpdateProductEndpointLogic(r.Context(), svcCtx)
		resp, err := l.UpdateProductEndpoint(&req)
