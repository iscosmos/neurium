...
func GetProductSchemaModuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetProductSchemaModuleReq
		...
		l := productschemamodule.NewGetProductSchemaModuleLogic(r.Context(), svcCtx)
		resp, err := l.GetProductSchemaModule(&req)
