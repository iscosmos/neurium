...
func UpdateProductSchemaModuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateProductSchemaModuleReq
		...
		l := productschemamodule.NewUpdateProductSchemaModuleLogic(r.Context(), svcCtx)
		resp, err := l.UpdateProductSchemaModule(&req)
